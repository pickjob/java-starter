...
public class JMXServerShowCase {
    ...
    public static void main(String[] args) {
		try {
			...
			mbs.registerMBean(new basic.jmx.standard.Hello(), helloObjectName1);
			//Notification MBean
            ObjectName helloObjectNam2 = new ObjectName("jmx.notify:type=mbean, name=Hello");
            mbs.registerMBean(new basic.jmx.notify.Hello(), helloObjectNam2);
            //Dynamic MBean
            ObjectName helloObjectNam3 = new ObjectName("jmx.dynamic:type=mbean, name=Hello");
            mbs.registerMBean(new basic.jmx.dynamic.Hello(), helloObjectNam3);
