...
public class MySqlShowCaseBase {
    ...
    protected static Connection createConnection() throws Throwable {
        return DriverManager.getConnection("jdbc:mysql://localhost/sample?autoReconnect=true&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true", "china", "chinese");
    }
}
