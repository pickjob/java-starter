 ...
 * @time 2019-06-12
 **/
public class CurveFittedAreaChartShowCase extends Application {
...
class CurveFittedAreaChart extends AreaChart<Number, Number> {
    ...
    @Override protected void layoutPlotChildren() {
        ...
        for (int index = 0; index < getDataSize(); index++) {
            final Series<Number, Number> series = getData().get(index);
